...
public class Version1 {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Michael", 105, 40, 6));
    
        List<Employee> transferredEmployees = transferEmployees(employees);
    ...
    public static List<Employee> transferEmployees(List<Employee> employees) {
        List<Employee> transferredEmployees = new ArrayList<>();
        for (Employee emp : employees) {
            if (emp.getWorkingYears() < 5) {
                transferredEmployees.add(emp);
            }
        }
        employees.removeAll(transferredEmployees);
